...
const (
	...
	WalletService_Transfer_FullMethodName   = "/payaja.WalletService/Transfer"
)
...
var WalletService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "payaja.WalletService",
